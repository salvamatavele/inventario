...
class Paginator
{
    ...
    public function render(string $cssClass = null, bool $fixedFirstAndLastPage = true): ?string
    {
        ...
        if ($this->rows > $this->limit):
            $paginator = "<ul class=\"{$this->class}\">";
            $paginator .= $this->firstPage($fixedFirstAndLastPage);
            $paginator .= "<li class='waves-effect'><a href='#!'>{$this->beforePages()}</a></li>";
            $paginator .= "<li class='active'><a href='#!'>{$this->page}</a></li>";
            $paginator .= "<li class='waves-effect'><a href='#!'>{$this->afterPages()}</a></li>";
